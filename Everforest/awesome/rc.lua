...
beautiful.menu_bg_normal = "#2b3238"
beautiful.menu_bg_focus = "#d1c7ac"
beautiful.menu_fg_normal = "#d1c7ac"
beautiful.menu_fg_focus = "#2b3238"
beautiful.menu_height = 32
beautiful.menu_width = 170
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "d", function() awful.util.spawn("rofi -show window") end,
              {description = "run wndow launcher", group = "launcher"}),
              
                            
    -- Browser
    awful.key({ modkey }, "b", function() awful.util.spawn("brave-browser") end,
              {description = "run  default browser", group = "launcher"}),
              
    -- Editor
    awful.key({ modkey }, "e", function() awful.util.spawn("gedit") end,
              {description = "run text editor", group = "launcher"})
...
awful.util.spawn("/home/arya/.config/polybar/launch.sh") 


--Custom Wallpaper
gears.wallpaper.maximized("/home/arya/Pictures/jpeverforest.jpg", s)
